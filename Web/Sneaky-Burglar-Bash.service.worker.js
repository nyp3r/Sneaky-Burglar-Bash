...
/** @type {string} */
const CACHE_VERSION = '1763538818|3376701918';
/** @type {string} */
const CACHE_PREFIX = 'Stellas Teddy Be-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Sneaky-Burglar-Bash.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Sneaky-Burglar-Bash.html","Sneaky-Burglar-Bash.js","Sneaky-Burglar-Bash.offline.html","Sneaky-Burglar-Bash.icon.png","Sneaky-Burglar-Bash.apple-touch-icon.png","Sneaky-Burglar-Bash.audio.worklet.js","Sneaky-Burglar-Bash.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Sneaky-Burglar-Bash.wasm","Sneaky-Burglar-Bash.pck"];
